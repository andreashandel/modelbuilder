...
#files = "D:/Github/andreashandel/modelbuilder/auxiliary/modelfiles/Stratified_Inoculum_Model_file.R"
#files = "D:/Github/andreashandel/modelbuilder/auxiliary/modelfiles/other/Influenza_OAS_Model_file.R"
...
#files = "D:/Github/andreashandel/modelbuilder/auxiliary/modelfiles/Basic_Inoculum_Model.rds"
for (n in 1: length(files))
{
...
files = list.files(path = modelfilepath, pattern = "\\.Rds$", full.names = TRUE)
#files = "D:/Github/andreashandel/modelbuilder/auxiliary/modelfiles/Stratified_Inoculum_Model.Rds"
#files = "D:/Github/andreashandel/modelbuilder/auxiliary/modelfiles/Basic_Inoculum_Model.rds"
