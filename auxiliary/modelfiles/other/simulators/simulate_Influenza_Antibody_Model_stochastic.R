...
simulate_Influenza_Antibody_Model_stochastic <- function(Hf = 10000, Hb = 0, B = 1, A = 1, k = 0.01, df = 0.5, db = 0.5, s = 1, del = 0, p = 0, a = 0, g = 0.1, dA = 0.1, tfinal = 100, rngseed = 123) 
{ 
