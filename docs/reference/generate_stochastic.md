...
``` r
generate_stochastic(mbmodel, location = NULL, filename = NULL)
```
...
This function takes as input a modelbuilder model and writes code for a
stochastic simulator function implemented with adaptivetau
