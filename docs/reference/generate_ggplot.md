...
- res:
  ...
  optional: plottype - One of "Lineplot" (default if nothing is
  ...
  1.5 if not supplied.\
  optional: pallette - overwrite plot colors by providing a vector of
  color names or hex numbers to be used for the plot.\
